<?php
	...
	class SocketServer
	{
		...
		/*!	@var		activate_debug
			@abstract	boolean - Activate debug mode?.
		 */
		public $activate_debug = false;
		...
		*/
		...
		{
			SocketServer::debug("Sent --> {$string}");
